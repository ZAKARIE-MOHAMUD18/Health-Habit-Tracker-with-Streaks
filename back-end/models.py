...
class User(db.Model, SerializerMixin):
    ...
    user_challenges = db.relationship("UserChallenge", back_populates="user", cascade="all, delete")
...
class Challenge(db.Model, SerializerMixin):
    ...
    user_challenges = db.relationship("UserChallenge", back_populates="challenge", cascade="all, delete")
